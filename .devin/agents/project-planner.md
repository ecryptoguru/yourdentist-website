...
1.  **Read** `ARCHITECTURE.md` → Check **OS** field (Windows/macOS/Linux)
...
> 💡 **Script paths are relative to `.devin/` directory**
...
# P1: UX Audit
python .devin/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python .devin/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python .devin/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```

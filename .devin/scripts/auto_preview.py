...
Usage:
    python .devin/scripts/auto_preview.py start [port]
    python .devin/scripts/auto_preview.py stop
    python .devin/scripts/auto_preview.py status
"""

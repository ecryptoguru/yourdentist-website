...
Usage:
    python .devin/scripts/verify_all.py . --url <URL>
...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Dependency Analysis", ".devin/skills/vulnerability-scanner/scripts/dependency_analyzer.py", False),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Type Coverage", ".devin/skills/lint-and-validate/scripts/type_coverage.py", False),
        ]
    },
    ...
    # P3: Testing
    {
        "category": "Testing",
        "checks": [
            ("Test Suite", ".devin/skills/testing-patterns/scripts/test_runner.py", False),
        ]
    },
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ...
            ("Accessibility Check", ".devin/skills/frontend-design/scripts/accessibility_checker.py", False),
        ]
    },
    ...
    # P5: SEO & Content
    {
        ...
        "checks": [
            ...
            ("GEO Check", ".devin/skills/geo-fundamentals/scripts/geo_checker.py", False),
        ]
    },
    ...
    # P6: Performance (requires URL)
    {
        ...
        "checks": [
            ...
            ("Bundle Analysis", ".devin/skills/performance-profiling/scripts/bundle_analyzer.py", False),
        ]
    },
    ...
    # P8: Mobile (if applicable)
    {
        "category": "Mobile",
        "checks": [
            ("Mobile Audit", ".devin/skills/mobile-design/scripts/mobile_audit.py", False),
        ]
    },
    ...
    # P9: Internationalization
    {
        ...
        "checks": [
            ("i18n Check", ".devin/skills/i18n-localization/scripts/i18n_checker.py", False),
        ]
    },
]
...
Examples:
  ...
  python .devin/scripts/verify_all.py . --url https://staging.example.com --no-e2e
        """
    )

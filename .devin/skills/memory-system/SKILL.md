...
1. Read `.devin/memory/MEMORY.md` index
...
1. Grep across `.devin/memory/*.md` for the search term
...
```
1. Check: Does `.devin/memory/MEMORY.md` exist?
...
|----------|---------|----------|----------|
| **Memory** | Cross-session knowledge | Permanent until pruned | `.devin/memory/` |

...
## Trigger Words (Auto-Invoke)

When the user says any of these, automatically run verification:

- "final checks", "son kontrolleri yap", "çalıştır tüm testleri"
- "verify", "does this work", "test this"
- "run tests", "check build", "validate"

**Action:** Execute `python .devin/scripts/checklist.py .`

---
description: Coordinate multiple agents for complex tasks. Use for multi-perspective analysis, comprehensive reviews, or tasks requiring different domain expertise. Includes both full 2-phase orchestration and a lightweight mode for research + synthesis.
---

# /orchestrate — Multi-Agent Orchestration

> **Two modes:**
> - **Full Mode** (below) — 2-phase orchestration with planning gate, parallel implementation, and verification scripts. Best for complex builds.
> - **Lightweight Mode** — Skip planning gate, go straight to research → synthesis → implementation → verification. Best for analysis and review tasks.
...
> Full roster in `ARCHITECTURE.md`. Below are the most commonly invoked agents.
...
```bash
python .devin/skills/vulnerability-scanner/scripts/security_scan.py .
python .devin/skills/lint-and-validate/scripts/lint_runner.py .
```
